...
export default function PPokemon() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                let url = "https://pokeapi.co/api/v2/pokemon/196";
                if (id) {
                        ...
                        <div className="card border-success">
                            ...
                            <div className="card-body">
                                <div style={{
                                    ...
                                    <Collapse Texto="Espeon" TextoEsconder= "Ocultar Espeon">
                                        <Card header={dataJson.name}>
                                             <Alert color="danger" texto={dataJson.types[0].type.name} />
                                            <Carrusel tiempo={1500}>
                                            ...
                                            <Datalist
                                                titulo="Estadísticas"
                                                opciones={dataJson.stats.map(stat => `${stat.stat.name}: ${stat.base_stat}`)}
                                                id="estadisticas"
                                            /> 
                                        </Card>
                                    </Collapse>
